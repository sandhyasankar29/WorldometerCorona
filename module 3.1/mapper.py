...
#        print(i)
        if(i.strip()!=''):
            if(query=='a'):
                try:
                    abc = open('module15/{}_ActiveCases.txt'.format(i), 'r+',encoding='utf-8')
#                    print(a.readlines())
                    for l in abc :
#                        print(l)
                        try:
    ...
    #                        new_cases = int(data[5])
                ...
                try:
                    abc = open('module15/{}_DailyDeaths.txt'.format(i), 'r+',encoding='utf-8')
#                    print(a.readlines())
                    for l in abc :
#                        print(l)
                        try:
    ...
    #                        new_cases = int(data[5])
                ...
                try:
                    abc = open('module15/{}_RecoveredCases.txt'.format(i), 'r+',encoding='utf-8')
#                    print(a.readlines())
                    for l in abc :
#                        print(l)
                        try:
    ...
    #                        new_cases = int(data[5])
                ...
                try:
                    abc = open('module15/{}_NewCases.txt'.format(i), 'r+',encoding='utf-8')
#                    print(a.readlines())
                    for l in abc :
#                        print(l)
                        try:
