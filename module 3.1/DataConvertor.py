...
#    fileWrite('NewCases.txt',newCase,dates4)
    ...
    fileWrite('./Module15/{}_ActiveCases.txt'.format(countries[ch]),countries[ch].replace(" ", ""), activeCases,dates1)
    fileWrite('./Module15/{}_DailyDeaths.txt'.format(countries[ch]),countries[ch].replace(" ", ""), dailyDeath,dates2)
    fileWrite('./Module15/{}_RecoveredCases.txt'.format(countries[ch]),countries[ch].replace(" ", ""), newRecovered,dates3)
    fileWrite('./Module15/{}_NewCases.txt'.format(countries[ch]),countries[ch].replace(" ", ""), newCase,dates4)
