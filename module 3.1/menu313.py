...
def main():
    ...
    command = "python3 module15/mapper.py {} {} {} {} | sort -n | python3 module15/combiner.py | sort -n | python3 module15/reducer.py".format(country_name, start_date.strftime('%d-%m-%Y'), end_date.strftime('%d-%m-%Y'), query)
